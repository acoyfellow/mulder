...
await writeFile(join(out, "og.svg"), `<svg xmlns="${svgNamespace}" width="1200" height="630"><rect width="1200" height="630" fill="#06100a"/><circle cx="950" cy="120" r="300" fill="#143522"/><text x="80" y="110" fill="#66ff91" font-family="monospace" font-size="26" letter-spacing="7">MULDER</text><text x="80" y="280" fill="#e8fff0" font-family="system-ui" font-weight="700" font-size="70">Your website already knows</text><text x="80" y="370" fill="#e8fff0" font-family="system-ui" font-weight="700" font-size="70">what it can do.</text><text x="80" y="480" fill="#66ff91" font-family="system-ui" font-weight="700" font-size="54">Let browser agents use it.</text></svg>`);
await writeFile(join(out, "demo-poster.svg"), `<svg xmlns="${svgNamespace}" width="1280" height="580"><rect width="1280" height="580" fill="#06100a"/><text x="90" y="90" fill="#66ff91" font-family="monospace" font-size="18">OPENAPI → NATIVE BROWSER TOOL</text><text x="90" y="215" fill="#e8fff0" font-family="system-ui" font-weight="700" font-size="66">Your API already has an</text><text x="90" y="300" fill="#66ff91" font-family="system-ui" font-weight="700" font-size="66">agent interface.</text><rect x="90" y="370" width="1100" height="120" rx="14" fill="#0b1c11" stroke="#66ff91"/><text x="125" y="440" fill="#e8fff0" font-family="monospace" font-size="24">▶ Watch the verified native call</text></svg>`);
