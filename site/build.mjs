...
const footer = `<footer class="site-footer"><div class="shell footer-inner"><span>Mulder 0.1 · Public preview</span><div class="footer-links"><a href="/docs/browser-support/">Browser support</a><a href="/docs/security/">Security</a><a href="/docs/reference/">Reference</a></div></div></footer>`;
