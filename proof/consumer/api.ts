...
*{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(circle at 78% 18%,#143522 0,transparent 34%),#06100a;color:#e8fff0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}main{width:min(1080px,calc(100% - 64px));margin:auto;padding:56px 0}.top{display:flex;justify-content:space-between;align-items:center;margin-bottom:58px}.brand{font-size:15px;font-weight:800;letter-spacing:.2em;text-transform:uppercase}.live{display:flex;gap:9px;align-items:center;color:#8cb69a;font-size:13px}.dot{width:9px;height:9px;border-radius:50%;background:#66ff91;box-shadow:0 0 18px #66ff91}.eyebrow{color:#66ff91;text-transform:uppercase;letter-spacing:.15em;font-size:13px}h1{font:700 clamp(44px,7vw,76px)/.98 system-ui,sans-serif;letter-spacing:-.055em;max-width:830px;margin:16px 0 22px}h1 span{color:#66ff91}.intro{color:#a9c8b3;font:18px/1.6 system-ui,sans-serif;max-width:680px;margin:0 0 42px}.flow{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.step{position:relative;border:1px solid #28583a;background:#0b1c11cc;border-radius:16px;padding:22px;min-height:146px}.step.done{border-color:#4fcf72;background:#0d2515}.number{color:#688d73;font-size:12px}.state{position:absolute;right:18px;top:18px;color:#66ff91;font-size:12px}.step h2{font:650 18px system-ui,sans-serif;margin:28px 0 8px}.step p{color:#91ae99;font-size:13px;line-height:1.5;margin:0}.result{margin-top:14px;border:1px solid ${complete ? "#66ff91" : "#28583a"};border-radius:16px;background:#07150c;padding:24px;display:grid;grid-template-columns:190px 1fr;gap:24px;align-items:center}.result-label{color:${complete ? "#66ff91" : "#789582"};font-size:12px;letter-spacing:.12em;text-transform:uppercase}.result-label strong{display:block;color:#e8fff0;font:650 20px system-ui,sans-serif;letter-spacing:0;text-transform:none;margin-top:8px}pre{margin:0;color:${complete ? "#d9ffe5" : "#6e8f78"};font:14px/1.55 ui-monospace,monospace;white-space:pre-wrap}.foot{display:flex;justify-content:space-between;color:#587361;font-size:11px;margin-top:18px}@media(max-width:760px){main{width:min(100% - 32px,1080px);padding:28px 0}.flow{grid-template-columns:1fr}.result{grid-template-columns:1fr}.top{margin-bottom:38px}}
